...
try:
    ...
    print("AI Data Assistant initialized with Gemini AI")
except ImportError as e:
    ai_assistant = None
...
def ai_assistant_upload():
    ...
    try:
        ...
        # Validate file type
        if not ai_allowed_file(file.filename):
            return jsonify({'error': 'Invalid file type. Supported formats: CSV, Excel (.xlsx, .xls), JSON, Parquet'}), 400
